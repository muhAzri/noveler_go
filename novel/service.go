...
type Service interface {
	...
	SearchNovels(input NovelSearchParametersInput) ([]Novel, error)
}
...
func (s *service) SearchNovels(input NovelSearchParametersInput) ([]Novel, error) {
	novels, err := s.repository.SearchNovels(input)
	if err != nil {
		return novels, err
	}
